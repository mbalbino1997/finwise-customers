...
const AnimatedButton = ({ text = "JoinToday", altText = "JoinNow", onClick }) => {
    ...
    const handleClick = (e) => {
        ...
        // Reset the focus state after animation completes
        setTimeout(() => {
            setIsFocused(false);
        }, 2000);
    };
    ...
    return (
        ...
        .button:active .bg::before {
          ...
          box-shadow:
            -7px 6px 0 0 rgba(115, 75, 155, 0.4),
            -14px 12px 0 0 rgba(115, 75, 155, 0.25),
            -21px 18px 4px 0 rgba(115, 75, 155, 0.15);
        }
        ...
        .char.state-2 span::after,
        .button-focused .char.state-1 span {
          animation: charDisappear 0.5s ease forwards calc(var(--i) * 0.03s);
        }

        .button-focused .char.state-2 span::after {
      ...
      `}</style>
            <button
                className={`button ${isFocused ? 'button-focused' : ''}`}
                onClick={handleClick}
            >
                    ...
                    <div className="content">
                        <span className="char state-1">
                            {text.split('').map((char, index) => (
                                <span key={index} data-label={char} style={{ '--i': index + 1 }}>{char}</span>
                            ))}
                        </span>
